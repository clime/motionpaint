...
class CameraDevice(QtCore.QObject):
    ...
    @property
    def fps(self):
        fps = int(cv.GetCaptureProperty(self._cameraDevice, cv.CV_CAP_PROP_FPS)) # FIXME: generates HIGHGUI ERROR
        if not fps > 0:
...
class CameraWidget(QtGui.QWidget):
    ...
    def _onNewFrame(self, frame):
        ...
        self.mainWindow.new_frame.emit(self._frame)
        self.update()
    ...
    @property
    def frameSize(self):
        return self._cameraDevice.frameSize
